    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-8 offset-lg-2">
                <h2 class="text-primary text-center p-2 fw-bold">South Indian Meal - Delivery</h2>
            </div>
        </div>
        <form action="{{route('canteen.deliverySim')}}" method="get">
            @csrf
            @method('get')
            <div class="row">
                <div class="col-lg-8 offset-lg-2">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4">
                              <center>
                                ...
                                <a href="{{route('canteen.deliverySim')}}" class="btn  mt-2 btn-danger">Reset</a> 
                              </center>
                    ...
                    <div class="bg-white p-3 shadow">
                        ...
                        <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-md-6"> 
                                        <div class="card bg-primary text-white  p-2 shadow">
                                            ...
                                            <h1 class=" text-white fw-bold  h1">x {{$result['sim'] ? $result['sim'] : 0 }}</h1>
                                            </div>
                            ...
                            <div class="col-lg-12">
                                ...
                                <a href="{{route('canteen.deliverySim')}}" class="btn btn-danger">Back</a>
                                </center>
